...
export function ContactUs() {
  return (
    <section id="contact" className="py-28 relative overflow-hidden border-t border-white/10 bg-[#04040b]">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          >
            <Card className="h-full p-8 md:p-10 border-[#00f0ff]/35 bg-[linear-gradient(155deg,rgba(8,10,18,0.95),rgba(4,4,11,0.8))] shadow-[0_0_0_1px_rgba(0,240,255,0.12),0_20px_60px_rgba(0,0,0,0.5)]">
              ...
              <div className="inline-flex items-center gap-3 mb-8 border border-[#00f0ff]/40 bg-[#00f0ff]/12 px-4 py-2">
              ...
              <h3 className="text-2xl md:text-3xl font-orbitron tracking-[0.08em] text-white mb-5 uppercase leading-tight">
              ...
              <div className="mt-8 pt-6 border-t border-white/10 flex flex-wrap items-center gap-4 justify-between">
          ...
          <motion.div
            ...
            className="h-full"
          >
            <Card className="h-full p-3 md:p-4 border-[#ff4d00]/35 bg-[linear-gradient(160deg,rgba(18,9,7,0.82),rgba(6,7,14,0.82))] shadow-[0_0_0_1px_rgba(255,77,0,0.1),0_20px_60px_rgba(0,0,0,0.45)]">
              <div className="relative h-[340px] md:h-[420px] overflow-hidden rounded-sm border border-white/15">
                <iframe
        ...
        <div className="mt-16 pt-16 border-t border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            <motion.div
              ...
              whileHover={{ y: -6 }}
            >
              <Card className="p-6 border-[#00f0ff]/35 bg-[linear-gradient(160deg,rgba(0,240,255,0.08),rgba(0,0,0,0.45))]">
            ...
            <motion.div
              ...
              whileHover={{ y: -6 }}
            >
              <Card className="p-6 border-[#ff4d00]/35 bg-[linear-gradient(160deg,rgba(255,77,0,0.08),rgba(0,0,0,0.45))]">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                  <div>
